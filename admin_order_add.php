            ...
            <div class="col-12 col-lg-10">
                ...
                <div class="row">
                    <div class="col-12" style="padding-left: 10px; padding-right:2px;">
                        <form class="form-horizontal" id="form1" name="form1" action="admin_order_verify.php?op=3" method="POST">
                            <div class="form-group logbox">
                                <input type="hidden" name="time" value="<?php echo date("Y/m/d H:i:s", time());?>">
                                <h2 style="margin-right:2%;text-align:center; text-decoration:underline; text-underline-position: under;">新增訂單</h2>
                                <br><br>
                                <table cellspacing="2" cellpadding="10" align=center>
                                    ...
                                    <tr>
                                        <td width='400'>
                                            <input type="text" id="cost" name="cost" size="30" maxlength="30">
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td width='400'>
                                            <textarea name="list" cols="50" rows="10"></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">&nbsp;</td>
